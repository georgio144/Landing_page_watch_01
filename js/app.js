...
if (iconMenu != null) {
   ...
   iconMenu.addEventListener("click", function (e) {
      if (unlock) {
         body_lock(delay);
         iconMenu.classList.toggle("_active1");
...
function menu_close() {
   let iconMenu = document.querySelector(".menu__icon");
   let menuBody = document.querySelector(".menu__body");
   iconMenu.classList.remove("_active1");
   menuBody.classList.remove("_active1");
}
//=================
//BodyLock
...
let main_slider_1 = new Swiper('.slider-lots__body', {
   /*
   effect: 'fade',
   autoplay: {
      delay: 3000,
   ...
   */
   ...
   breakpoints: {
      320: {
         slidesPerView: 1,//указываем кол-во слайдов на разных ширинах экрана
      },
      550: {
         slidesPerView: 2,
      },
